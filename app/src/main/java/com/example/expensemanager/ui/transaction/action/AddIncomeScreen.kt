...
fun AddIncomeScreen(
    ...
    var selectedGroup by remember { mutableStateOf(incomeCategoryGroups.first().name) }
    var category by remember { mutableStateOf(incomeCategoryGroups.first().subCategories.first()) }
